...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($_POST['Specialization'])) {
            ...
            $s = mysqli_real_escape_string($connect, trim($_POST['InsuranceNumber']));
        }
        ...
        if (empty($_POST['Password'])) {
            ...
            $p = mysqli_real_escape_string($connect, trim($_POST['Diagnose']));
        }
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        <p><br><label class="label" for="Specialization"> Insurance Number: </label>
